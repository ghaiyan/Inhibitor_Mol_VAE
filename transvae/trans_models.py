...
"""     
    ...
    def train(self, train_mols, val_mols, train_props=None, val_props=None,
        ...
        for epoch in range(epochs):
            ...
            for j, data in enumerate(train_iter):
                ...
                for i in range(self.params['BATCH_CHUNKS']):
                    ...
                    if self.model_type == 'transformer':
                        print("src, tgt, src_mask, tgt_mask:",src.shape, tgt.shape, src_mask.shape, tgt_mask.shape)
            ...
            with open("trials/train_val_loss_file.txt", "a+") as f:
                f.write("\t".join((str(self.n_epochs),str(train_loss),str(val_loss),str(beta)))+'\n')
                f.close()
...
class TransVAE(VAEShell):
    ...
    def build_model(self):
        ...
        print("self.src_len:",self.src_len)
...
class VAEEncoder(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        if self.bypass_bottleneck:
            ...
            #print("mem:",mem.shape)
            #print("self.z_var(mem):",self.z_var(mem).shape)
